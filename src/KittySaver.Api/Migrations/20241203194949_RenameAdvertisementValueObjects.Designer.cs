...
namespace KittySaver.Api.Migrations
{
    ...
    [Migration("20241203194949_RenameAdvertisementValueObjects")]
    partial class RenameAdvertisementValueObjects
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KittySaver.Domain.Persons.Person", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FirstName", "KittySaver.Domain.Persons.Person.FirstName#FirstName", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("LastName", "KittySaver.Domain.Persons.Person.LastName#LastName", b1 =>
                        {
                            b1.IsRequired();
