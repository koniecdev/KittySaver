...
namespace KittySaver.Auth.Api.Migrations
{
    ...
    [Migration("20250406172517_AuditableEntityRefactor")]
    partial class AuditableEntityRefactor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KittySaver.Auth.Api.Shared.Domain.Entites.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KittySaver.Auth.Api.Shared.Domain.Entites.RefreshToken", b =>
                {
                    b.HasOne("KittySaver.Auth.Api.Shared.Domain.Entites.ApplicationUser", "ApplicationUser")
                        .WithMany()
