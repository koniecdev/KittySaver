...
public class GetAdvertisementEndpointsTests : IAsyncLifetime
{
    ...
    public async Task GetAdvertisement_ShouldReturnExpectedState_WhenAdvertisementIsCreated()
    {
        ...
        //Act
        HttpResponseMessage response = await _httpClient.GetAsync($"api/v1/advertisements/{createAdvertisementResponse.Id}");
        
        //Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK);
        AdvertisementResponse advertisement = await response.GetResponseFromResponseMessageAsync<AdvertisementResponse>();
        ...
        advertisement.PersonName.Should().Be(createPersonRequest.FirstName);
    ...
    public async Task GetAdvertisement_ShouldReturnExpectedState_WhenAdvertisementIsUpdated()
    {
        ...
        await _httpClient.PutAsJsonAsync($"api/v1/advertisements/{createAdvertisementResponse.Id}", updateAdvertisementRequest);
